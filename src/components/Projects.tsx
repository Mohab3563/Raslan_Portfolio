...
const projects: Project[] = [
{
  ...
  {
    title: 'E-Commerce',
    description: 'A modern React-based e-commerce web application with a smooth checkout experience, product cart system, and secure order handling. It includes customer details, multiple payment methods, receipt upload, and automated order notifications via email and WhatsApp. Built with Vite and React for fast performance and responsive user experience across all devices.',
    image: 'https://i.ibb.co/LDP1ptds/Screenshot-2026-05-24-113423.png',
    tags: ['React', 'TypeScript', 'Supabase', 'DnD'],
    category: 'React',
    stars: 196,
    forks: 31,
    liveUrl: 'https://ecommerceshop2.netlify.app/',
    repoUrl: 'https://github.com/Mohab3563/E-commerce',
    featured: true,
  },
  {
